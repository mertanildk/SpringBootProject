...
public class EURKPSPublicSoap
{
    ...
    public EURKPSPublicSoap(){}

    public EURKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public EURKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        EURExtendedSoapSerializationEnvelope envelope= new EURExtendedSoapSerializationEnvelope(EURExtendedSoapSerializationEnvelope.VER11);
