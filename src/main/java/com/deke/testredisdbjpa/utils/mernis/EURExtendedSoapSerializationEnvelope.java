...
public class EURExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(EURDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new EURStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static EURDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static EURDateTimeConverter dateTimeConverter = new EURStandardDateTimeConverter();

    public EURExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public EURExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new EURMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=EURHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,EURExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=EURHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
